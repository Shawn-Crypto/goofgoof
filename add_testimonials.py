# Script to add testimonials section to index.html
import re
...
# Add CSS for testimonials section before the closing style tag
css_addition = """        /* Testimonials Section */
        .testimonials {
...
content = content.replace('        /* Final CTA */', css_addition + '        /* Final CTA */')
...
# Update progress dots to include testimonials
content = content.replace(
...
# Add testimonials section after instructor section
testimonials_html = """
            ...
            <div class="testimonials-grid">
                ...
                <div class="testimonial-card">
                    <div class="testimonial-header">
                        <img src="placeholder-arjun.jpg" alt="Arjun Mehta" class="testimonial-avatar">
                ...
                <div class="testimonial-card">
                    <div class="testimonial-header">
                        <img src="placeholder-priya.jpg" alt="Priya Sharma" class="testimonial-avatar">
                        <div class="testimonial-info">
                            <h4>Priya Sharma</h4>
                            <p>Doctor, Mumbai</p>
                            <div class="rating">★★★★★</div>
                ...
                <div class="testimonial-card">
                    <div class="testimonial-header">
                        <img src="placeholder-rajesh.jpg" alt="Rajesh Kumar" class="testimonial-avatar">
                        <div class="testimonial-info">
                            <h4>Rajesh Kumar</h4>
                ...
                <div class="testimonial-card">
                    <div class="testimonial-header">
                        <img src="placeholder-sneha.jpg" alt="Sneha Patel" class="testimonial-avatar">
                        <div class="testimonial-info">
                            <h4>Sneha Patel</h4>
                            <p>CA, Ahmedabad</p>
                            <div class="rating">★★★★★</div>
                ...
                <div class="testimonial-card">
                    <div class="testimonial-header">
                        <img src="placeholder-amit.jpg" alt="Amit Agarwal" class="testimonial-avatar">
                        <div class="testimonial-info">
                            <h4>Amit Agarwal</h4>
                ...
                <div class="testimonial-card">
                    <div class="testimonial-header">
                        <img src="placeholder-kavita.jpg" alt="Kavita Reddy" class="testimonial-avatar">
                        <div class="testimonial-info">
                            <h4>Kavita Reddy</h4>
...
# Update mobile responsive CSS to include testimonials
mobile_css = """
